...
RUN Rscript -e 'remotes::install_version("tsibble",upgrade="never", version = "1.1.1")'
...
RUN Rscript -e 'remotes::install_version("feasts",upgrade="never", version = "0.2.2")'
...
RUN Rscript -e 'remotes::install_version("corrr",upgrade="never", version = "0.4.3")'
